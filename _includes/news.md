...
<ul id="scrollableDiv" onmouseover="showScrollbar()" onmouseout="hideScrollbar()">
  ...
  <li><b>[2026.05]</b>  We release <a href="https://01yzzyu.github.io/UFO/">UFO</a>, a benchmark for compositional multimodal reasoning in unified models — <a href="https://huggingface.co/datasets/yzzyu/UFO">dataset</a> and <a href="https://github.com/01yzzyu/UFO">code</a> are now open-sourced. </li>
